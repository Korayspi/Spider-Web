function [Fnod, F_elem, Nodm, max_val]=relax_6err_spis(Nodm, A, ele_L0, Fapp, moving, I, J, ele_type, error)
    scl_un=1e-2;
    dx_un=0.1*scl_un;
    vars(1)=1.01;
    vars(2)=1e-5*scl_un;
    ...
    [Fnod, F_elem] = ForceCalc_Z_spis(Fapp, Nodm, A, ele_L0, I, J, ele_type);
    Nod_best=Nodm;
    Fnod_best=Fnod;
    F_elem_best=F_elem;
